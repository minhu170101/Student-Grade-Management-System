...
namespace Quản_lý_điểm_sinh_vien_CNTT
{
    public partial class frmQLDiem : Form
    {
        ...
        private void frmQLDiem_Load(object sender, EventArgs e)
        {
            ...
            {
                string chon = "Select * From tblKET_QUA";
                SqlCommand thucthi = new SqlCommand(chon, conn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (reader1.Read())
            {
                ...
                cmd1.Dispose();
                // Thực hiện truy vấn
                string insert = "Insert Into tblKET_QUA(MaSV,HoTen,MaLop,MaMon,DiemChuyenCan,DiemKT,DiemThi,HanhKiem,HocKi,GhiChu)" +
                "Values('" + txtMaSV.Text + "',N'" + txtHoTen.Text + "','" + cboLop.Text + "',N'" + cboMonHoc.Text + "','" + txtDiemChuyenCan.Text + "','" +
                 txtDiemKT.Text + "','" + txtDiemThi.Text + "',N'" + cboHanhKiem.Text + "',N'" +
        ...
        private void dgrDiem_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtDiemChuyenCan.Text = dgrDiem.CurrentRow.Cells[4].Value.ToString();
            txtDiemKT.Text = dgrDiem.CurrentRow.Cells[5].Value.ToString();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                string update = "Update tblKET_QUA Set HoTen=N'" + txtHoTen.Text + "',MaMon=N'" +cboMonHoc.Text + "',MaLop='" + 
                                cboLop.Text + "',DiemChuyenCan='" + txtDiemChuyenCan.Text + "',DiemKT='" +txtDiemKT.Text + "' ,DiemThi='" + 
                                txtDiemThi.Text + "',HanhKiem=N'" + cboHanhKiem.Text + "',HocKi=N'" + cboHocKi.Text + "',GhiChu=N'" +
